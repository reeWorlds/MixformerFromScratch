def make_ae_config():
    ...
    coder_cfg = {"part1_channels": 64, "part2_channels": 80, "part3_channels": 96, "target_h": 48,
               "target_w": 48, "search_h": 64, "search_w": 64, "pos_enc_channels": 32, "type_channels": 32,
               "embeddings": embed_dim, "target_out_h": 12, "target_out_w": 12, "search_out_h": 16,
               "search_out_w": 16, "agg_channels": 16, "agg_size": 32}
